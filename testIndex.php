...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // NEU HINZUGEFÜGT: Funktion zum Initialisieren des Hero-Bereichs
        function initializeHero() {
            heroImageElement.style.backgroundImage = `url('${heroImages[currentImageIndex]}')`;
            console.log('Hero initialisiert mit:', heroImages[currentImageIndex]);
        }
        ...
        // NEU HINZUGEFÜGT: Initialisiere Hero sofort beim Laden
        initializeHero();
