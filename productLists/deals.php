...
<body>
    <?php
        // Product loading logic (already implemented)
        $category = 'angebote'; 
    ...
    <div class="main-content">
            ...
            <ul class="sidebar-menu">
                <?php if (!empty($unterkategorien_list)): ?>
                    <?php foreach ($unterkategorien_list as $uk): ?>
                        <li><a href="../<?php echo htmlspecialchars($uk['link']); ?>"><?php echo htmlspecialchars($uk['name']); ?></a></li>
                    <?php endforeach; ?>
                <?php else: ?>
                    <!-- Optional: Display a message if no subcategories, or leave empty -->
        ...
        <div class="products">
            ...
            <div class="categories">
                <?php foreach ($unterkategorien_list as $uk): ?>
                    <a href="../<?php echo htmlspecialchars($uk['link']); ?>" class="category-item">
            ...
            <?php else: ?>
            <!-- Hide this section-title if no unterkategorien or handle as needed -->
