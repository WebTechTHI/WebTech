...
<body>
    ...
    <form id="configure-form" class="configure-form" method="post" action="/index.php?page=configurator&action=configurationSubmit"
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="connector" id="connector" onchange="updatePriceTag('connector', 'connector-price-container')">

                    <option value="" data-price="">- keine -</option>

                    <?php foreach ($connectors as $connector): ?>
                        <option value="<?= $connector["connectors_id"] ?>" data-price="<?= $connector['price']?>"><?= htmlspecialchars($connector["spec"]) ?>
                        </option>
                    <?php endforeach; ?>

                    
                </select>
                <div class="price-container" id="connector-price-container" style="background-color:transparent;"></div>
            </div>
        </div>
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="cpu" id="cpu" onchange="updatePriceTag('cpu', 'cpu-price-container')">
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="storage" id="storage" onchange="updatePriceTag('storage', 'storage-price-container')">
                ...
                <div class="price-container" id="storage-price-container" style="background-color:transparent;"></div>
            </div>
        </div>
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="gpu" id="gpu" onchange="updatePriceTag('gpu', 'gpu-price-container')">
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="os" id="os" onchange="updatePriceTag('os', 'os-price-container')">

                    <option value="" data-price="">- keine -</option>

                    <?php foreach ($operatingSystems as $os): ?>
                        <option value="<?= $os["os_id"] ?>" data-price="<?= $os['price']?>"><?= htmlspecialchars($os["name"]) ?></option>
                    <?php endforeach; ?>
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="ram" id="ram" onchange="updatePriceTag('ram', 'ram-price-container')">
        ...
        <div class="select-wrapper">
            ...
            <div class="component-wrapper">
                ...
                <select class="component-select" name="network" id="network" onchange="updatePriceTag('network', 'network-price-container')">
                ...
                <div class="price-container" id="network-price-container" style="background-color:transparent;"></div>
            </div>
        </div>
